namespace :db do
  ...
  task :populate => :environment do
    ...
    User.find_or_create_by_username({:username => 'euser', :display_name => 'External Client User',
                                     :email => 'euser@example.com', :role_id => 4, :client_id => 1,
                                     :password => 'euser',  :password_confirmation => 'euser'})    
  end
end